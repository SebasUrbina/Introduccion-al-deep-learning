...
- Objetivo: 
  - Pregunta 1: Comprender el algoritmo de *forward pass* y *backpropagation*.
  - Pregunta 2: Predecir la cesación de un cliente con datos bancarios. Utilizando un arquitectura *feedforward*.
